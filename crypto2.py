...
def RSA(action):
    if action == '2':
        ...
        if action == '1':
            ...
            Tk().withdraw()
            outkeyfile = asksaveasfilename(initialdir=filedir, title='Save as...')
            print(outfile)
            ...
            Tk().withdraw()
            keyfilepath = askopenfilename(initialdir=filedir, title='Choose the encrypted key file...')
            print(keyfilepath)
        ...
        if action == '1':
            ...
            signature = asksaveasfilename(initialdir=filedir, title='Select signature filename...') or None
            print(signature)
            ...
            signature = askopenfilename(initialdir=filedir, title='Select signature file...')
            print(signature)
